#!/usr/bin/env python3
"""Quick test script for Phase 12 Regime Filter V3"""
...
os.environ['MODEL_RUN_DIR'] = 'models/regime_v3_test'
os.environ['TT_MAX_CYCLES'] = '500'
os.environ['TT_PRINT_EVERY'] = '100'
os.environ['PAPER_TRADING'] = 'True'

print("=" * 60)
print("Phase 12: Regime Filter V3 Test")
print("=" * 60)
