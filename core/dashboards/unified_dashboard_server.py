...
Environment Variables:
    DASHBOARD_PORT - Server port (default: 5001)
...
# Add project root to path (two levels up from core/dashboards/)
_PROJECT_ROOT = Path(__file__).parent.parent.parent.resolve()
sys.path.insert(0, str(_PROJECT_ROOT))
os.chdir(_PROJECT_ROOT)  # Change to project root for relative paths
